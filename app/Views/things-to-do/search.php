...
<div class="main-content-container">
    ...
    <div class="top-attractions-container content-container">
        <div class="top-attractions-header-container">
            <h5 class="top-attractions-header">Top Attractions in <?= esc(ucfirst($country)) ?></h5>
        </div>
        <div class="container">
            <div class="row">
                ...
                <?php if(!empty($things_to_do) && is_array($things_to_do)): ?>
                    ...
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"><?= esc($thing_to_do['name']) ?></h5>
