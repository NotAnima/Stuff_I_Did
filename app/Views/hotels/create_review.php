...
<div class="main-content-container">
    <div class="restaurant-review-container content-container">
        <div class="row">
            <div class="col-5">
                ...
                <div class="restaurant-details-container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; max-width: 200px;"><?= esc($hotel['name']) ?></h5>
                            <h6 class="card-subtitle" style="overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; max-width: 200px;"><?= esc($hotel['street_address']) ?></h6>
            ...
            <div class="col-7">
                <form action="<?= base_url('hotels/create-review/') . $country . '/' . $hotel_id ?>" method="post">
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        <label class="form-label">When did you go?</label>
                        <input type="date" class="form-control" name="visit-date">
                    </div>
                    <div class="mb-5">
                        <label class="form-label">Write your review</label>
                        <textarea rows="5" minlength="100" name="review" class="form-control" placeholder="This sport is great for a casual night out..."></textarea>
                    </div>
                    <div class="mb-5">
                        <label class="form-label">Title your review</label>
                        <input type="text" name="review-title" placeholder="Give us the gist of your experience" class="form-control text">
                    </div>
                    <div>
